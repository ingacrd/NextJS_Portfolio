...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="text-white container mb-16">
      <div className="md:grid md:grid-cols-5 gap-10 items-start py-10 px-4 xl:px-16">
        {/* IMAGE COLUMN */}
        ...
        {/* TEXT + TABS COLUMN */}
        <div className="md:col-span-3 mt-8 md:mt-0 flex flex-col h-full text-left">
          {/* Title + subtitle */}
